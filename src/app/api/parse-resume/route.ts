...

{
  ...
  "current_salary": null,
  "desired_salary": null,
  "category": "REQUIRED — must be exactly one of: sales, sales_engineering, channel, marketing, product, customer_success, operations, engineering, other. These are BROAD categories based on their most recent role's primary function: sales = any sales role (AE, SDR, sales manager, etc.). sales_engineering = pre-sales engineers, solutions architects, SE managers. channel = channel managers, partner managers, alliances, GSI roles. marketing = all marketing functions. product = product managers, product owners. customer_success = CSMs, implementation, onboarding. operations = RevOps, sales ops, marketing ops. engineering = software engineers, DevOps, security engineers. other = cross-functional C-suite roles or anything that doesn't fit above.",
