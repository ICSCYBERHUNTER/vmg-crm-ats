...
export const COMPANY_TYPE_LABELS: Record<string, string> = {
  cybersecurity_vendor: 'Cybersecurity Vendor',
  technology_vendor: 'Technology Vendor',
  managed_security_provider: 'MSSP / MDR Provider',
  var_reseller: 'VAR / Reseller',
  systems_integrator: 'Systems Integrator',
  consulting_advisory: 'Consulting / Advisory',
  asset_owner_end_user: 'Asset Owner / End User',
  government_public_sector: 'Government / Public Sector',
  investor: 'Investor (PE/VC)',
  research_institution_lab: 'Research Institution / Lab',
  other_needs_review: 'Other / Needs Review',
}

export const PRIMARY_SEGMENT_LABELS: Record<string, string> = {
  ot_ics_cps_security: 'OT / ICS / CPS Security',
  connected_product_security: 'Connected Product Security',
  ...
  security_operations: 'Security Operations (SOC/SIEM)',
  threat_intelligence: 'Threat Intelligence',
  vulnerability_exposure_mgmt: 'Vulnerability & Exposure Mgmt',
  offensive_security_validation: 'Offensive Security & Validation',
  email_security: 'Email Security',
  grc_risk_compliance: 'GRC / Risk & Compliance',
  third_party_risk_mgmt: 'Third-Party Risk Mgmt',
  security_awareness_training: 'Security Awareness Training',
  general_multi_domain: 'General / Multi-Domain',
}

export const INDUSTRY_VERTICAL_LABELS: Record<string, string> = {
  energy: 'Energy',
