...
const FILE_TYPE_LABELS: Record<CompanyDocument['file_type'], string> = {
...
interface Props {
  ...
  onSetPrimary: (doc: CompanyDocument) => Promise<void>
  onDownload: (doc: CompanyDocument) => Promise<void>
  onDelete: (doc: CompanyDocument) => Promise<void>
}

export function CompanyDocumentList({ documents, onSetPrimary, onDownload, onDelete }: Props) {
