-- Phase 2C: Bump hybrid_search SQL branch caps to address recall failures
-- Audit baseline: run-20260509-2220
-- 76% of expected candidates failed at SQL retrieval (never reached hybrid_rows)
-- Candidate branches: 30 → 50; non-candidate branches: 10 → 25; result_limit default: 50 → 75
