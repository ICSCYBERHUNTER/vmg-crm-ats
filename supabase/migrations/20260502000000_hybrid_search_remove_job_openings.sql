-- =============================================================================
-- Remove job_openings from hybrid_search()
--
-- Job openings are managed directly from company pages, not surfaced via
-- Smart Search. Removing them from the hybrid retrieval pool reduces noise
-- and focuses Smart Search results on candidates, companies, contacts, and notes.
--
-- What changes:
--   - JOB OPENINGS: semantic CTE removed
--   - JOB OPENINGS: keyword CTE removed
--   - Both UNION ALL connectors for job openings removed
--
-- What does NOT change:
--   - job_openings table, embedding columns, or search_vector trigger
--   - formatJobOpening() TypeScript function
--   - global_search() RPC (header search)
--   - RRF / ranking / deduplication logic
--   - All other entity branches (candidates, companies, contacts, notes)
--   - filter_entity_type = 'job_opening' now simply returns 0 rows
-- =============================================================================
