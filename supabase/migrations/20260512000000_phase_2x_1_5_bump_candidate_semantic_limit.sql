-- Phase 2X.1.5: Bump candidate semantic branch LIMIT and result_limit default
-- Date: 2026-05-10
--
-- Problem: Recall audit showed 9 of 11 panel-expected candidates never entered
-- hybrid_search()'s top-75 pool. Root cause: candidate semantic branch LIMIT 50
-- was too tight — strong-but-not-top-50 candidates were cut before the outer
-- deduplication + reranker sort could rescue them.
--
-- Changes (two only):
--   1. result_limit DEFAULT: 75 → 150
--   2. Candidate semantic branch LIMIT: 50 → 150
--
-- Unchanged: candidate keyword branch LIMIT (50), companies/contacts/notes LIMITs (25),
