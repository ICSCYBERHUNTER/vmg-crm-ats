...
-- search across candidates, companies, contacts, job openings, and notes.
--
-- Called by the /api/search/smart route with a pre-computed query embedding.
-- global_search() is untouched — keyword-only search continues to use it.
-- =============================================================================
